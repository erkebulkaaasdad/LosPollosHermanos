...
TRANSLATIONS = {
    'ru': {
        ...
        'description': 'Видел проблему в городе? Сообщи нам, и получи вознаграждение! LosPollos — это просто: найди проблему, сфотографируй, отправь — и получи деньги.',
        ...
        'state_funding_title': 'Поддержка государства',
        'state_funding_desc': 'Государство платит за улучшение города. Твои деньги — из бюджета Казахстана.',
        'for_citizens': 'Для граждан',
        'citizen_desc': 'Видишь мусор, яму или сломанный светофор? Отправь фото — и помоги городу.',
        'for_workers': 'Для работников',
        'worker_desc': 'Выполни задачу, отправь фото результата — получи 5 000 ₸ на счет.',
        'rewards': 'Магазин',
        'rewards_desc': 'Потрати свои тенге на крутые вещи в нашем магазине.',
