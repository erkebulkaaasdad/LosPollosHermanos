...
TRANSLATIONS = {
    'ru': {
        'welcome_title': 'LosPollos — Городские Решения',
        'tagline': 'Ваш вклад в улучшение города начинается здесь.',
        'start_button': 'Начать сейчас',
        'how_it_works': 'Как это работает?',
        'description': 'LosPollos — это инновационная платформа, созданная для эффективного взаимодействия граждан и городских служб. Мы помогаем быстро выявлять и устранять проблемы, делая наш город чище, безопаснее и комфортнее для всех.',
        'trash_on_streets': 'Мусор на улицах? Сообщите нам!',
        'potholes_on_roads': 'Ямы на дорогах? Мы поможем их исправить!',
        'illegal_dumps': 'Незаконные свалки? Давайте бороться с ними вместе!',
        'state_funding_title': 'При поддержке государства',
        'state_funding_desc': 'Проект LosPollos реализуется при активной поддержке Правительства Казахстана. Все финансовые вознаграждения для исполнителей задач выделяются из государственного бюджета в рамках программы по благоустройству и развитию городской инфраструктуры.',
        'for_citizens': 'Для активных граждан',
        'citizen_desc': 'Сообщайте о любых городских проблемах — от мусора и ям на дорогах до неработающего освещения. Отслеживайте статус выполнения ваших заявок в реальном времени и будьте частью позитивных изменений.',
        'for_workers': 'Для ответственных исполнителей',
        'worker_desc': 'Принимайте доступные заявки, выполняйте работы по устранению проблем, предоставляйте фотоотчеты и получайте достойное вознаграждение от государства за каждый успешно выполненный заказ.',
        'rewards': 'Бонусы и Магазин',
        'rewards_desc': 'За каждую успешно выполненную задачу вы получаете 5 000 ₸, которые можно обменять на ценные призы и эксклюзивные товары в нашем специальном магазине LosPollos.',
    ...
    'kk': {
        ...
        'tagline': 'Қаланы жақсартуға қосқан үлесіңіз осы жерден басталады.',
        'start_button': 'Қазір бастау',
        'how_it_works': 'Бұл қалай жұмыс істейді?',
        'description': 'LosPollos — бұл азаматтар мен қалалық қызметтердің тиімді өзара әрекеттесуі үшін жасалған инновациялық платформа. Біз мәселелерді тез анықтауға және жоюға көмектесеміз, қаламызды барлығы үшін таза, қауіпсіз және ыңғайлы етеміз.',
        'trash_on_streets': 'Көшелердегі қоқыс? Бізге хабарлаңыз!',
        'potholes_on_roads': 'Жолдардағы шұңқырлар? Біз оларды жөндеуге көмектесеміз!',
        'illegal_dumps': 'Заңсыз қоқыс үйінділері? Олармен бірге күресейік!',
        'state_funding_title': 'Мемлекеттік қолдау',
        'state_funding_desc': 'LosPollos жобасы Қазақстан Үкіметінің белсенді қолдауымен жүзеге асырылады. Тапсырмаларды орындаушыларға арналған барлық қаржылай сыйақылар қалалық инфрақұрылымды абаттандыру және дамыту бағдарламасы аясында мемлекеттік бюджеттен бөлінеді.',
        'for_citizens': 'Белсенді азаматтар үшін',
        'citizen_desc': 'Кез келген қалалық мәселелер туралы хабарлаңыз — қоқыстан және жолдардағы шұңқырлардан бастап, жұмыс істемейтін жарықтандыруға дейін. Өтінімдеріңіздің орындалу барысын нақты уақыт режимінде қадағалаңыз және оң өзгерістердің бір бөлігі болыңыз.',
        'for_workers': 'Жауапты орындаушылар үшін',
        'worker_desc': 'Қолжетімді өтінімдерді қабылдаңыз, мәселелерді жою бойынша жұмыстарды орындаңыз, фотоесептерді ұсыныңыз және әрбір сәтті орындалған тапсырыс үшін мемлекеттен лайықты сыйақы алыңыз.',
        'rewards': 'Бонустар және Дүкен',
        'rewards_desc': 'Әрбір сәтті орындалған тапсырма үшін сіз 5 000 ₸ аласыз, оны біздің арнайы LosPollos дүкенінде құнды сыйлықтар мен эксклюзивті тауарларға айырбастауға болады.',
