...
TRANSLATIONS = {
    ...
    'kk': {
        ...
        'description': 'Қалада мәселе көрдің бе? Бізге айт, сыйақы ал! LosPollos — бұл оңай: мәселені тап, суретке түсір, жібер — ақшаңды ал.',
        ...
        'state_funding_title': 'Мемлекет қолдауымен',
        'state_funding_desc': 'Қаланы жақсартуға мемлекет төлейді. Сенің ақшаң — Қазақстан бюджетінен.',
        'for_citizens': 'Азаматтар үшін',
        'citizen_desc': 'Қоқыс, шұңқыр немесе сынған бағдаршам көрдің бе? Суретке түсіріп жібер — қалаға көмектес.',
        'for_workers': 'Жұмысшылар үшін',
        'worker_desc': 'Тапсырманы орында, нәтижесін суретке түсіріп жібер — шотыңа 5 000 ₸ ал.',
        'rewards': 'Дүкен',
        'rewards_desc': 'Өз теңгеңді біздің дүкендегі керемет заттарға жұмса.',
